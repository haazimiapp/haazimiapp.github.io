...
import { Bell, Shield, User, DollarSign } from 'lucide-react';
...
export default function Settings({ user, language }) {
  ...
  const isTeacher = !['Admin', 'Manager', 'manager'].includes(user?.role);
  ...
  const [notifications, setNotifications] = useState({
    leaveApproval: true, newRequest: true, redFlags: true, calendarEvents: false, weeklyReport: true,
  });
